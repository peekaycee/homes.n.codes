...
const Shops = () => {
  ...
  useEffect(() => {
    const handleDocumentClick = (event) => {
      const clickableLink = document.querySelector('#root > div.carousel-container > div > div > div:nth-child(5) > a');
  ...
  return (   
   ...
   {isLinkClicked && <h2>Available Shops</h2>}
    <section className='Shop-listings'>
        ...
        {Listings.map((listing, index) => (
          <div className='box' key={`${listing.id}-${index}`}>
            ...
            <div className='thumb'>
              ...
              <form action='' method='post' className='save' id='shop-form'>
                <button
                  type='submit'
                  title='save'
                  name='save'
              ...
              <img src={listing.image} alt='Image of a Shops' />
            </div>
